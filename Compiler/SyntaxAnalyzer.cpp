...
SyntaxAnalyzer::SyntaxAnalyzer(LexicalAnalyzer& lexical_analyzer) throw()
    ...
    , token_()
    , is_successful_(true)
    , syntax_process_buffer_()
    , syntax_format_string_() {}
...
string SyntaxAnalyzer::toString() const throw() { return syntax_process_buffer_.str(); }
    ...
    switch (error_type) {
        ...
        case WRONGENDINGTOKEN:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be '.' at the end of program\n";
            break;
        case REDUNDANTTOOKEN:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "redundant token after '.'\n";
            break;
        case NOSTATEMENTBLOCK:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "didn't find statement block in subroutine\n";
            break;
        case LACKSEMICOLON:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be ';' after the sentence(or do you forget ','?)\n";
            break;
        case LACKIDENTIFIER:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
        ...
        case LACKCONSTANT:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be constant integer or character\n";
            break;
        case LACKTYPECOLON:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be ':' to specify the type\n";
            break;
        case LACKLEFTBRACKET:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be '[' to specify an array\n";
            break;
        case LACKRIGHTBRACKET:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
        ...
        case LACKCONSTINTEGER:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "need a constant integer\n";
            break;
        case LACKOF:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be \"of\" after [] to specify array type\n";
            break;
        case LACKRWTYPE:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
        ...
        case WRONGFACTOR:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "illegal factor, should be a value or variable\n";
            break;
        case LACKTHEN:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "need \"then\" after if condition\n";
            break;
        case LACKLOGICOPERATOR:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be a logic operator or \"then\", ')' or \"||\" or \"&&\"\n";
            break;
        case LACKCONSTANTORIDENTIFIER:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be constant integer or character or identifier\n";
            break;
        case LACKCASECOLON:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
                 << "should be ':' to specify the case action\n";
            break;
        case LACKDO:
            cout << "  line " << token_.lineNumber_ << ": " << errline
                 << " \terror token: " << token_.toString() << "\nerror info: "
