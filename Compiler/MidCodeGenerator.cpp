...
// <实在参数表> ::= <表达式>{,<表达式>}
vector<ExpressionAttribute> MidCodeGenerator::ArgumentList(const vector<ExpressionAttribute> &parameter_attributes, size_t depth) throw()			// 实参表
{
...
void MidCodeGenerator::AssigningStatement(const Token &idToken, TokenTable::iterator &iter, size_t depth)			// 赋值语句
{
...
//// <过程调用语句> ::= '('[<实在参数表>]')'
//void MidCodeGenerator::ProcedureCallStatement(const Token proc_token, const vector<TokenTableItem::DecorateType> &parameter_decorate_types, size_t depth)	// 过程调用语句
//{
...
//
//// <函数调用语句> ::= '('[<实在参数表>]')'
//void MidCodeGenerator::FunctionCallStatement(const Token func_token, const vector<TokenTableItem::DecorateType> &parameter_decorate_types, size_t depth)	// 函数调用语句
//{
...
// <过程/函数调用语句> ::= '('[<实在参数表>]')'
void MidCodeGenerator::ProcFuncCallStatement(const Token proc_token, const vector<ExpressionAttribute> &parameter_attributes, size_t depth)	// 过程调用语句
{
