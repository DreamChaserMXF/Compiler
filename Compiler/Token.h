...
public:
	...
	enum TokenType{
		...
		/*Operator(23)*/		PERIOD, COMMA, SEMICOLON, SINGLE_QUOTATION, DOUBLE_QUOTATION, COLON, ASSIGN, LEFT_BRACKET, RIGHT_BRACKET, LEFT_PAREN, RIGHT_PAREN, PLUS, MINUS, MUL, DIV, LOGICOR, LOGICAND, LT, LEQ, GT, GEQ, EQU, NEQ
	};
	// 单词类
	struct TokenValue{
		int integer;
